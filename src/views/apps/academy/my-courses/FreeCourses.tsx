            ...
            <div className='border rounded bs-full'>
              <div className='mli-2 mbs-2 overflow-hidden rounded'>
                <ReactPlayer
                  ...
                  light={<img src='/images/apps/academy/7.png' alt='Thumbnail' className='is-full h-50 object-cover' />}
                  playIcon={
                    <CustomIconButton variant='contained' color='error' className='absolute rounded-full is-12 bs-12'>
            ...
            <div className='border rounded bs-full'>
              <div className='mli-2 mbs-2 overflow-hidden rounded'>
                <ReactPlayer
                  ...
                  height={200}
                  className='bg-black !is-full'
                  light={<img src='/images/apps/academy/8.png' alt='Thumbnail' className='is-full h-50 object-cover' />}
                  playIcon={
                    <CustomIconButton variant='contained' color='error' className='absolute rounded-full is-12 bs-12'>
                      <i className='bx-play text-2xl' />
                    </CustomIconButton>
