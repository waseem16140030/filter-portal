        ...
        <div className={styles.header}>
          ...
          <div className='flex gap-4'>
            <div onClick={resetSettings} className='relative flex cursor-pointer'>
              <i className='bx-refresh text-textPrimary' />
              <div className={classnames(styles.dotStyles, { [styles.show]: isSettingsChanged })} />
            </div>
            <i className='bx-x text-textPrimary cursor-pointer' onClick={handleToggle} />
          </div>
        </div>
        <ScrollWrapper
          {...(isBelowLgScreen
        ...
        >
          <div className={styles.customizerBody}>
            <div className='flex flex-col gap-6'>
              <Chip label='Theming' variant='tonal' size='small' color='primary' className='self-start' />
              <div className='flex flex-col gap-2'>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  >
                    ...
                    >
                      <i className='bx-color-fill text-xl' />
                    </div>
                  </div>
                  <Popper
                    transition
              ...
              <div className='flex flex-col gap-2'>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <div className='flex flex-col items-start gap-0.5'>
                    ...
                    >
                      <i className='bx-desktop text-[30px]' />
                    </div>
            ...
            <div className='flex flex-col gap-6'>
              <Chip label='Layout' variant='tonal' size='small' color='primary' className='self-start' />
              <div className='flex flex-col gap-2'>
