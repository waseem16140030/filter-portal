                ...
                <div className='flex items-center justify-between gap-2'>
                  <div className='flex items-center gap-2 overflow-hidden'>
                    ...
                    <IconButton onClick={e => handleToggleStarEmail(e, email.id)}>
                      <i className={classnames('bx-star', email.isStarred ? 'text-warning' : 'text-textSecondary')} />
                    </IconButton>
                    ...
                    >
                      <div className='flex items-center gap-2'>
                        {email.labels.map(label => (
                          <i
                            key={label}
                            className={classnames('bx-bxs-circle text-[8px]', labelColors[label].colorClass)}
                          />
                        ))}
                      </div>
                        ...
                        >
                          <i
                            className={classnames(
                              'text-textSecondary',
                              email.isRead ? 'bx-envelope' : 'bx-envelope-open'
                            )}
                          />
                        </IconButton>
                      </Tooltip>
