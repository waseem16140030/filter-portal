...
const recentDeviceData: RecentDeviceDataType[] = [
  {
    ...
    browserIcon: <i className='bx-bxl-windows text-[22px] text-info' />
  },
  {
    ...
    browserIcon: <i className='bx-bxl-android text-[22px] text-success' />
  },
  {
    location: 'Switzerland',
    device: 'Macbook Pro',
    ...
    browserIcon: <i className='bx-bxl-apple text-[22px] text-warning' />
  },
  {
    ...
    browserIcon: <i className='bx-mobile-alt text-[22px] text-error' />
  },
  {
    location: 'India',
    device: 'Apple iMac',
    ...
    browserName: 'Chrome on MacOS',
    browserIcon: <i className='bx-bxl-apple text-[22px] text-secondary' />
  },
  {
    location: 'Dubai',
              ...
              <tr key={index}>
                <td>
                  <div className='flex items-center gap-2.5'>
                    {device.browserIcon}
                    <Typography variant='h6'>{device.browserName}</Typography>
                  </div>
                </td>
                <td>
