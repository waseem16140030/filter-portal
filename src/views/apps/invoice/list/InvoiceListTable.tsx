  ...
  return (
    <Card>
      <CardContent className='flex justify-between flex-col items-start md:items-center md:flex-row gap-4'>
        <div className='flex flex-col sm:flex-row is-full sm:is-auto items-start sm:items-center justify-between gap-4'>
        ...
        <div className='flex flex-col sm:flex-row max-sm:is-full items-start sm:items-center gap-4'>
          <DebouncedInput
            ...
            className='min-is-[250px] is-full sm:is-auto'
          />
          <CustomTextField
            select
            id='select-status'
            ...
            className='min-is-[160px] is-full sm:is-auto'
            slotProps={{
