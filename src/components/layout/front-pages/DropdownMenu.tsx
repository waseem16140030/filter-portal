  ...
  return (
    <Tag {...(isBelowLgScreen && { className: 'flex flex-col' })}>
      <Typography
        variant='h6'
        component={Link}
        className={classnames('flex items-center gap-2 plb-3 pli-1.5 hover:text-primary', {
          'text-primary':
        ...
        <div className='flex flex-col gap-4'>
          ...
          {pageData.map((page, index) => (
            <Link
              ...
              className={classnames('flex items-center gap-2 focus:outline-hidden hover:text-primary', {
                'text-primary': pathname.includes('/front-pages' + page.href)
              })}
              onClick={handleLinkClick}
            >
              <i className='bx-circle text-[10px]' />
        ...
        <div className='flex flex-col gap-4'>
          ...
          {authData.map((page, index) => (
            <Link
              ...
              target='_blank'
              className='flex items-center gap-2 focus:outline-hidden hover:text-primary'
              onClick={handleLinkClick}
            >
              <i className='bx-circle text-[10px]' />
              <span>{page.title}</span>
