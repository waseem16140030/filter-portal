    ...
    <Card>
      <CardContent className='flex flex-wrap items-center justify-between gap-4'>
        ...
        <div className='flex items-center gap-4'>
          ...
          <i className='bx-share-alt cursor-pointer' />
          <i className='bx-bookmark cursor-pointer' />
        </div>
      </CardContent>
      <CardContent>
            ...
            <ReactPlayer
              ...
              light={
                <img
                  ...
                  alt='Thumbnail'
                  className='is-full h-70 sm:h-110 object-cover bg-backgroundPaper'
                />
              }
              playIcon={
                <CustomIconButton variant='contained' color='error' className='absolute rounded-full'>
                  <i className='bx-play text-2xl' />
                </CustomIconButton>
              }
            />
          </div>
              ...
              <div className='flex flex-wrap gap-x-12 gap-y-2'>
                <List role='list' component='div' className='flex flex-col gap-2 plb-0'>
                  <ListItem role='listitem' className='flex items-center gap-2 p-0'>
                    <i className='bx-check text-xl text-textSecondary' />
                    <Typography>Skill level: {data?.skillLevel}</Typography>
                  </ListItem>
                  <ListItem role='listitem' className='flex items-center gap-2 p-0'>
                    <i className='bx-group text-xl text-textSecondary' />
                    <Typography>Students: {data?.totalStudents.toLocaleString()}</Typography>
                  </ListItem>
                  <ListItem role='listitem' className='flex items-center gap-2 p-0'>
                    <i className='bx-globe text-xl text-textSecondary' />
                    <Typography>Languages: {data?.language}</Typography>
                  </ListItem>
                  <ListItem role='listitem' className='flex items-center gap-2 p-0'>
                    <i className='bx-file text-xl text-textSecondary' />
                    <Typography>Captions: {data?.isCaptions ? 'Yes' : 'No'}</Typography>
                  </ListItem>
                </List>
                <List role='list' component='div' className='flex flex-col gap-2 plb-0'>
                  <ListItem role='listitem' className='flex items-center gap-2 p-0'>
                    <i className='bx-video text-xl text-textSecondary' />
                    <Typography>Lectures: {data?.totalLectures}</Typography>
                  </ListItem>
                  <ListItem role='listitem' className='flex items-center gap-2 p-0'>
                    <i className='bx-time-five text-xl text-textSecondary' />
            ...
            <div className='flex flex-col gap-4'>
              ...
              <div className='flex items-center gap-4'>
                ...
                <div className='flex flex-col gap-1'>
                  <Typography variant='h6'>{data?.instructor}</Typography>
