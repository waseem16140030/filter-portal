                ...
                <Fragment key={index}>
                  <Timeline>
                    <TimelineItem>
                      ...
                      <TimelineContent className='flex flex-col gap-0.5 pbs-0 pbe-5 pis-5'>
                        <Typography variant='body2' className='uppercase' color='success.main'>
                          Sender
                        </Typography>
                        <Typography variant='h6'>{item.sender.name}</Typography>
                    ...
                    <TimelineItem>
                      ...
                      <TimelineContent className='flex flex-col gap-0.5 pbs-0 pbe-0 pis-5'>
                        <Typography variant='body2' className='uppercase' color='primary.main'>
                          Receiver
                        </Typography>
                        <Typography variant='h6'>{item.receiver.name}</Typography>
