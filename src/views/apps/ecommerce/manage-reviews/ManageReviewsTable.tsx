        ...
        cell: ({ row }) => (
          <div className='flex flex-col gap-1'>
            <Rating
              ...
              icon={<i className='bx-bxs-star text-[22px]' />}
              emptyIcon={<i className='bx-bxs-star text-[22px] text-actionDisabledBackground' />}
            />
            <Typography variant='h6'>{row.original.head}</Typography>
            <Typography variant='body2' className='text-wrap'>
              {row.original.para}
            </Typography>
          </div>
        ...
        <div className='flex justify-between flex-col items-start flex-wrap sm:flex-row sm:items-center gap-4 p-5'>
          ...
          <div className='flex flex-col sm:flex-row items-center gap-4 max-sm:is-full'>
            ...
            <CustomTextField
              ...
              className='max-sm:is-full sm:is-[140px] flex-auto'
            >
