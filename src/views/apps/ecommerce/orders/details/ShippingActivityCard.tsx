      ...
      <CardContent>
        <Timeline>
          <TimelineItem>
            ...
            <TimelineContent>
              <div className='flex flex-wrap items-center justify-between gap-x-2 mbe-2.5'>
                <Typography variant='h6'>Order was placed (Order ID: #{order})</Typography>
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              <div className='flex flex-wrap items-center justify-between gap-x-2 mbe-2.5'>
                <Typography variant='h6'>Dispatched</Typography>
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              <div className='flex flex-wrap items-center justify-between gap-x-2 mbe-2.5'>
                <Typography variant='h6'>Package arrived</Typography>
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              <div className='flex flex-wrap items-center justify-between gap-x-2 mbe-2.5'>
                <Typography variant='h6'>Dispatched for delivery</Typography>
