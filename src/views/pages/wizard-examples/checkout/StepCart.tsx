      ...
      <Grid size={{ xs: 12, lg: 8 }} className='flex flex-col gap-4'>
        <Collapse in={openCollapse}>
          <Fade in={openFade} timeout={{ exit: 300 }}>
            <Alert
              icon={<i className='bx-purchase-tag' />}
              action={
                <IconButton
                  aria-label='close'
                  color='inherit'
              ...
              <div className='flex flex-col sm:flex-row items-center sm:justify-between is-full'>
                <div className='flex flex-col items-center gap-2 sm:items-start'>
                  ...
                  <Rating
                    ...
                    size='small'
                    emptyIcon={<i className='bx-bxs-star text-textDisabled' />}
                    readOnly
                  />
                  <CustomTextField
                    size='small'
        ...
        >
          ...
          <DirectionalIcon ltrIconClass='bx-right-arrow-alt' rtlIconClass='bx-left-arrow-alt' className='text-lg' />
        </Typography>
      </Grid>
        ...
        <div className='border rounded'>
          <CardContent className='flex flex-col gap-4'>
            ...
            <div className='rounded bg-actionHover p-6 flex flex-col gap-2'>
              <Typography variant='h6'>Buying gift for a loved one?</Typography>
