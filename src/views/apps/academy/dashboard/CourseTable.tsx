  ...
  const columns = useMemo<ColumnDef<CourseWithProgress, any>[]>(
    () => [
      ...
      columnHelper.accessor('courseTitle', {
        ...
        cell: ({ row }) => (
          <div className='flex items-center gap-4'>
            <CustomAvatar variant='rounded' skin='light' color={row.original.color} size={40}>
      ...
      columnHelper.accessor('time', {
        header: 'Time',
        cell: ({ row }) => <Typography variant='h6'>{row.original.time}</Typography>,
        enableSorting: false
      }),
        ...
        cell: ({ row }) => (
          <div className='flex items-center gap-4 min-is-48'>
            <Typography variant='h6'>
              {`${Math.floor((row.original.completedTasks / row.original.totalTasks) * 100)}%`}
            </Typography>
            <LinearProgress
              color='primary'
        ...
        cell: ({ row }) => (
          <div className='flex items-center justify-between gap-2'>
            <div className='flex items-center gap-1.5'>
              <i className='bx-user text-primary' />
              <Typography>{row.original.userCount}</Typography>
            </div>
            <div className='flex items-center gap-1.5'>
              <i className='bx-book-open text-info' />
              <Typography>{row.original.note}</Typography>
            </div>
            <div className='flex items-center gap-1.5'>
              <i className='bx-video text-error' />
