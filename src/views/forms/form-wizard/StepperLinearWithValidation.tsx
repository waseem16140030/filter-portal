        ...
        return (
          <form key={0} onSubmit={handleAccountSubmit(onSubmit)}>
            <Grid container spacing={6}>
              <Grid size={{ xs: 12 }}>
                <Typography variant='h6'>{steps[0].title}</Typography>
      ...
      case 1:
        return (
          <form key={1} onSubmit={handlePersonalSubmit(onSubmit)}>
            <Grid container spacing={6}>
              <Grid size={{ xs: 12 }}>
                <Typography variant='h6'>{steps[1].title}</Typography>
      ...
      case 2:
        return (
          <form key={2} onSubmit={handleSocialSubmit(onSubmit)}>
            <Grid container spacing={6}>
              <Grid size={{ xs: 12 }}>
                <Typography variant='h6'>{steps[2].title}</Typography>
              ...
              <Grid size={{ xs: 12 }} className='flex justify-between'>
                ...
                <Button variant='contained' type='submit' endIcon={<i className='bx-check' />}>
                  Submit
                </Button>
              </Grid>
            </Grid>
