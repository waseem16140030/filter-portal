...
const PricingPlan = () => {
  ...
  return (
    ...
    >
      <div className={classnames('flex flex-col is-full', frontCommonStyles.layoutSpacing)}>
        ...
        <div className='relative flex justify-center items-center self-center gap-3 max-sm:mbe-4 sm:mbs-2 mbe-11'>
          ...
          <div className='absolute -end-2 translate-x-full flex gap-x-1 items-start max-sm:hidden mbe-4'>
        ...
        <Grid container spacing={6}>
          {pricingPlans.map((plan, index) => (
            <Grid size={{ xs: 12, lg: 4 }} key={index}>
              <Card className={classnames({ 'border-2 border-primary shadow-xl': plan.current })}>
